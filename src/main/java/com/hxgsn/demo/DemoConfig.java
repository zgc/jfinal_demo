...
//        me.setXmlRenderFactory(null);//设置xml渲染器工程
  ...
  public void configPlugin(Plugins me) {
    ...
    DruidPlugin druidPlugin1 = new DruidPlugin(
        "jdbc:mysql://localhost:3306/dev?characterEncoding=utf8", "root", "dev");
    me.add(druidPlugin1);
    ...
    ActiveRecordPlugin activeRecordPlugin1 = new ActiveRecordPlugin("mysql", druidPlugin1);
    activeRecordPlugin1.addMapping("tb_user", UserModel.class);
    activeRecordPlugin1.addMapping("tb_student", "name,grade", StudentModel.class);
    activeRecordPlugin1.setShowSql(true);
    activeRecordPlugin1.setDialect(new MysqlDialect());
